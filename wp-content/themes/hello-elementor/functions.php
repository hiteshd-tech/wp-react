...
function projects_custom_api_data($data, $post, $context) {
    ...
    if ($terms && !is_wp_error($terms)) {
        ...
        $data->data['project_categories'] = $categories;
    }

    return $data;
}

add_filter('rest_prepare_projects', 'projects_custom_api_data', 10, 3);